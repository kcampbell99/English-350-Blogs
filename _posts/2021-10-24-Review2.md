...
The project is accesible on desktop, laptop and smart phones. No matter how the user chooses to access this project, it is easy to navigate through the website. 
...
## Button Features
Under the "info" tab there is a historical narrative that describes the Roaring Twenties in great detail. Although this has potential to benfically aid the project, the font is very blurry and impossible to read. The quality needs to be improved in order for the user to easily read the content.
