...
The "Sound" tab seems very unnecessary because the video content could be included under the appropriate icons on the map. By clicking on the objects in the list, the user can select explained examples and or videos relating to that noise maker. The noise complaints and related information are already provided on the map when the user clicks on each icon. Embedding the videos from this section into the related icons on the map would allow access of all information in one concise area.
